"""
Django settings for exam_invigilator project.
...
ROOT_URLCONF = 'exam_invigilator.urls'
...
WSGI_APPLICATION = 'exam_invigilator.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'temp_invigilator', # Database name
        'USER': 'root',
        'PASSWORD': 'Bharat104@',
